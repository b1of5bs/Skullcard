...
document.getElementById('finalScoresTally5').addEventListener('click', function() {
    // Get player scores
    const scores = [
    ...
    ['totalPlayer1', 'totalPlayer2', 'totalPlayer3', 'totalPlayer4', 'totalPlayer5'].forEach((id, index) => {
