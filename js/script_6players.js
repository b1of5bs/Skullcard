...
document.getElementById('finalScoresTally6').addEventListener('click', function() {
    // Get player scores
    const scores = [
    ...
    ['totalPlayer1', 'totalPlayer2', 'totalPlayer3', 'totalPlayer4', 'totalPlayer5', 'totalPlayer6'].forEach((id, index) => {
