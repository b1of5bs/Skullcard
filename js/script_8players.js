document.addEventListener('DOMContentLoaded', function() {
    ...
    solidifyPlayerName('player8Name', 'player8Header');
});
...
function calculateTotals() {
    ...
    document.querySelectorAll('.score-input[data-player="8"]').forEach(input => {
        totalPlayer8 += Number(input.value) || 0;
    });
    ...
    document.getElementById('totalPlayer8').value = totalPlayer8;
}
...
function checkAndHideNameInputs() {
    ...
    var player8Name = document.getElementById('player8Name').value.trim();

    // Check if all names are entered
    if (player1Name !== '' && player2Name !== '' && player3Name !== '' && player4Name !== '' && player5Name !== '' && player6Name !== '' && player7Name !== '' && player8Name !== '') {
        ...
        document.getElementById('player8Name').style.display = 'none';
        ...
        document.getElementById('player8Header').textContent = player8Name;
    }
}
...
document.getElementById('player8Name').addEventListener('change', checkAndHideNameInputs);
...
document.getElementById('finalScoresTally8').addEventListener('click', function() {
    // Get player scores
    const scores = [
        ...
        parseInt(document.getElementById('totalPlayer8').value, 10) || 0
    ];
    ...
    ['totalPlayer1', 'totalPlayer2', 'totalPlayer3', 'totalPlayer4', 'totalPlayer5', 'totalPlayer6', 'totalPlayer7', 'totalPlayer8'].forEach((id, index) => {
